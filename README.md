...
- `Бюджет месяца`: `3400 300 1500 10`, где `10` — день зарплаты. Финансовый отчёт считается от этой даты до следующей зарплаты.
- `Продукты на неделю`: `200 вторник`. В отчёте будет показано, сколько из недельного лимита продуктов осталось до следующего вторника.
